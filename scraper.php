<?
	...
	for ($outterloop = 0; $outterloop < sizeof($Alpha); $outterloop++) 
		...
		scraperwiki::save_sqlite(array('name'), array('regno' => '$reg_no ', 'regdate' => '$reg_date', 'maker' => '$maker', 'model' => '$model', 'chas' => '$chassis_no', 'engine' => '$engine_no', 'owner' => 'echo $owner', 'sw' => '$sw', 'type' => '$type', 'link' => '$NewLink'));
